    ...
    <header class="site-header clearfix">
        <nav>
         ...
         <div class="menu"> 
          <ul>
           <li><a href="#"></a></li>
           <li ><a href="/train/usr.php">registers</a></li>
           <li><a href="/train/psg.php">passanger</a></li>
           <li ><a href="/train/trainl.php">train list</a></li>
           <li><a href="/train/welcome.php">logout</a></li>
