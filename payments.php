...
<body>
    ...
    $r_passno=$_SESSION['passno'];
    $t_no=$_SESSION['tno'] ;
    
    $t_amount=$_SESSION['tamt'];
    $u=$_SESSION['uname'];
    if(isset($_POST['pay']))
    {
    ...
    $query = "insert into payment values('$u','','$card_no','$card_holder','$exp_mm',$exp_yy,'$cvv')";
...
<div class="container">
    ...
    <form action="" method="POST">
        <div class="inputBox">
            ...
            <input type="text" maxlength="16" class="card-number-input" title="16 digits" name="card_num">
        </div>
        <div class="inputBox">
            <span>card holder</span>
